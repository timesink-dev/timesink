defmodule TimesinkWeb.CoreComponents do
  @moduledoc """
      ...
      >
        <div class="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            <div id={"#{@id}-content"} class="p-6 md:p-8">
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-md px-4 py-2",
        @color_classes,
        @class,
        @classes
      ]}
  ...
  def label(assigns) do
    ~H"""
    <label for={@for} class="block text-sm text-mystery-white mb-2">
      {render_slot(@inner_block)}
    </label>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TimesinkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TimesinkWeb.Gettext, "errors", msg, opts)
    end
  end
