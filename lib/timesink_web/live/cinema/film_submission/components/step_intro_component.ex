    ...
    <!-- Payment methods -->
          <div class="mt-8 flex items-center gap-3 text-sm text-gray-400">
            ...
            <div class="flex items-center gap-2">
              <div class="flex items-center gap-1.5 px-3 py-1.5 bg-gray-800/50 rounded-lg border border-gray-700/50">
                <svg
                  class="w-4 h-4"
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <div class="flex items-center gap-1.5 px-3 py-1.5 bg-orange-500/10 rounded-lg border border-orange-500/30">
                <svg
          ...
          <.button
            color="primary"
            class="w-full md:w-1/2 py-3 text-lg mt-8 mb-4"
