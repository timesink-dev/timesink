defmodule TimesinkWeb.Onboarding.StepUsernameComponent do
        ...
        >
          <div class="relative">
            ...
            <div class="relative">
              ...
              <.input
                ...
                required
                field={@form[:username]}
                input_class="w-full pl-9 pr-10 py-3 text-mystery-white border-none text-sm sm:text-base"
          ...
          <:actions>
            <div class="mt-4 sm:mt-6">
              <.button color="primary" class="w-full py-3 text-base sm:text-lg">
                Continue
              </.button>
            </div>
          </:actions>
  ...
  def handle_event("save_username", %{"username" => username} = username_params, socket) do
    ...
    with {:ok, :available} <- Account.is_username_available?(username),
      ...
      send(self(), {:update_user_data, %{params: username_params}})
