...
config :timesink, Timesink.Repo,
  ...
  database: System.get_env("PGDATABASE", "timesink_dev"),
...
config :timesink, TimesinkWeb.Endpoint,
  ...
  watchers: [
    ...
    tailwind: {Tailwind, :install_and_run, [:timesink, ~w(--watch)]}
  ]
...
config :timesink, TimesinkWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/timesink_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
